...
static class SceneAutoLoader
{
	...
	[MenuItem("Scene autoload/Choose initial scene")]
	...
	[MenuItem("Scene autoload/Load chosen scene on Play", true)]
	private static bool ShowLoadMasterOnPlay()
	{
		return !LoadMasterOnPlay;
	}
	[MenuItem("Scene autoload/Load chosen scene on Play")]
	private static void EnableLoadMasterOnPlay()
	{
		LoadMasterOnPlay = true;
	}
 
	[MenuItem("Scene autoload/Don't load chosen scene on Play", true)]
	private static bool ShowDontLoadMasterOnPlay()
	{
		return LoadMasterOnPlay;
	}
	
	[MenuItem("Scene autoload/Don't load chosen scene on Play")]
